...
zone_1 = formula_tanaka * 0.5, formula_tanaka * 0.6

zone_2 = formula_tanaka * 0.6, formula_tanaka * 0.7

zone_3 = formula_tanaka * 0.7, formula_tanaka * 0.8

zone_4 = formula_tanaka * 0.8, formula_tanaka * 0.9
